          ...
          <div class="item ">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/metaverse2.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">The Metaverse</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Matthew Ball</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/de/book/show/59064518">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/RPA.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">Robotics</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Neil Wilkins</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/44768709-robotics?from_search=true&from_srp=true&qid=8Xa1JqoRcS&rank=3">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/Atlas%20of%20AI.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">Atlas of AI</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autrice: <strong>Kate Crawford</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/50131136-atlas-of-ai?from_search=true&from_srp=true&qid=VIggR8uVKp&rank=1">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/MLBeginners.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">Machine Learning</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Samuel Hack</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/48498566-machine-learning-mathematics?from_search=true&from_srp=true&qid=yiGvxD5l12&rank=1">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/medicine3.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">Deep Medicine</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Eric Topol</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/40915762-deep-medicine?from_search=true&from_srp=true&qid=DXIcCBMxVo&rank=2">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/chat4.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">The ultimate guide to Chat GPT</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Chat GPT</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/123019127-the-ultimate-guide-to-chat-gpt---understanding-training-and-deploying-a?from_search=true&from_srp=true&qid=xiel8snrZv&rank=6">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/NFT2.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">The NFT</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Nathan Real</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/60142060-the-nft-handbook?from_search=true&from_srp=true&qid=2ENWjgMHQV&rank=9">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                ...
                <img src="../assets/images/Explore/codings.jpg" alt="" style="border-radius: 20px;">
                <h4 class="twolines">Computer Programming and Cyber Security</h4>
              </div>
              <div class="col-lg-12">
                <div class="line-dec"></div>
                <div class="row">
                  <div class="col-12">
                    <span>Autore: <strong>Zach Codings</strong></span>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
              ...
              <div class="col-lg-12">
                <div class="main-button">
                  <a href="https://www.goodreads.com/book/show/61729966-computer-programming-and-cybersecurity-for-beginners?ref=nav_sb_ss_3_12">Dettagli</a>
                </div>
              </div>
            </div>
          </div>
