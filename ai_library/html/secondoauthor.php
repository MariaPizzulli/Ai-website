        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                <span class="author">
                  <img src="../assets/images/autori/author.jpg" alt="" style="max-width: 50px; border-radius: 50%;">
                </span>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                <span class="author">
                  <img src="../assets/images/autori/author-02.jpg" alt="" style="max-width: 50px; border-radius: 50%;">
                </span>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                <span class="author">
                  <img src="../assets/images/autori/author-03.jpg" alt="" style="max-width: 50px; border-radius: 50%;">
                </span>
  ...
  <div class="create-nft">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="main-button">
            <a href="login%20signup.html">Create Your NFT Now</a>
          </div>
        </div>
        <div class="col-lg-4">
